...
<body>
    ...
    <div class="container" style="margin-bottom: 10%; margin-top: 5%;">
        ...
        <button class='btn btn-success' name='afegirpare' data-toggle='modal' style="position: absolute; top:20%" data-target='#ModalPare'><i class='fas fa-plus-circle'></i></button>
