        ...
        $(document).ready(function() {
            ...
            var t = $('#table').DataTable({
                ...
                columns: [{
                    ...
                    "defaultContent": "<button title='Añadir Hijo' type='submit' class='editar btn btn-info' data-toggle='modal' data-target='#exampleModal'><i class='fas fa-user-plus'></i></button><button style='margin-left:2%;' title='Eliminar Padre' type='submit' class='eliminar  btn btn-danger' data-toggle='modal' data-target='#eliminarPare'><i class='far fa-trash-alt'></i></button>",
